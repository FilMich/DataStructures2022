...
void main(array<String^>^)
{
	...
	structures::FileLogConsumer* fileLogConsumer = new structures::FileLogConsumer("log.csv");
...
// MainForm:
	...
	System::Void gui::MainForm::LogDuration(size_t size, structures::DurationType duration, const std::string& message)
	{
		String^ str = "Size: " + size + ", Duration: " + duration.count() + " ns, " + gcnew String(message.c_str());
